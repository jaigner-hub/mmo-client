...
public:
	...
	/**
	 * Get the current network state for synchronization
	 * @return FCombatNetworkState containing position, rotation, animation state, etc.
	 */
	UFUNCTION(BlueprintCallable, Category="Network")
	virtual FCombatNetworkState GetNetworkState() const;

	/**
	 * Get the current animation state for network sync
	 * @return ECombatAnimationState representing the current animation
	 */
	UFUNCTION(BlueprintPure, Category="Network")
	ECombatAnimationState GetCurrentAnimationState() const;
};
